...
/**
 * Struct which handles a pair of an input and output buffer to DMA ping/pong
 * operation
 */
typedef struct {
  /**
...
/**
 * Object of type AudioDMABuffer_t which always points to the buffers used for
 * processing
 */
