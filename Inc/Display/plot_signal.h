 ...
 *
 * @param samples      Pointer to array of float32_t containing the input
 * samples
 ...
 * @param xdiv         Distance between two ticks on the x-axis, if set to zero
 * ten equidistant ticks
 */
...
/**
 * @brief Plot a 2 channel signal on the display of the stm32f769i discovery
 * board
 *
 * @param samples      Pointer to array of float32_t containing the input
 * samples
